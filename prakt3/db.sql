...
INSERT INTO sales_order (order_id, order_date, customer_id, ship_date, total) values (132, '2022-03-11', 2, '2022-03-11', 30000);
SELECT COUNT(*) FROM sales_order WHERE total = 20000;

INSERT INTO sales_order (order_id, order_date, customer_id, ship_date, total) values (232, '2022-03-11', 2, '2022-03-11', 20000);
SELECT COUNT(*) FROM sales_order WHERE total = 30000;
